...
export const Hero: React.FC<HeroProps> = ({ onOpenBooking, onOpenCheckup }) => {
  return (
    <section id="home" className="pt-32 pb-20 md:pt-40 md:pb-28 bg-[#0a192f] text-white relative overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#112240] border border-[rgba(197,160,89,0.3)] text-[#c5a059] text-xs md:text-sm font-semibold tracking-wide shadow-sm">
              <ShieldCheck size={16} />
              <span>Ufficio Plurimandatario Assicurativo a Rho</span>
            </div>
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <button
                ...
                className="btn btn-primary btn-lg w-full sm:w-auto shadow-lg"
              >
                <Calendar size={18} />
            ...
            <div className="pt-1 flex items-center justify-center lg:justify-start gap-2 text-xs md:text-sm text-slate-400">
            ...
            <div className="pt-6 border-t border-[rgba(255,255,255,0.08)] grid grid-cols-2 sm:grid-cols-3 gap-3 text-left">
              ...
              <div className="flex items-center gap-2 text-xs md:text-sm text-slate-300 col-span-2 sm:col-span-1">
                <CheckCircle2 size={16} className="text-[#c5a059] shrink-0" />
          ...
          <div className="lg:col-span-5">
            <div className="bg-[#112240] p-6 sm:p-8 rounded-2xl border border-[rgba(197,160,89,0.25)] shadow-2xl relative">
              <div className="flex items-center justify-between border-b border-[#1e293b] pb-4 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-white font-bold text-lg leading-tight">S.F. Consulenze Assicurative</h3>
                    <p className="text-xs text-[#c5a059] font-medium">Referente unico: Simone Facchi</p>
                  </div>
                </div>
                <div className="w-9 h-9 rounded-full bg-[#1e293b] flex items-center justify-center text-[#c5a059] font-bold border border-[rgba(197,160,89,0.3)] text-xs shrink-0">
                  Rho
                </div>
              </div>

              <div className="space-y-4">
                <div className="bg-[#0a192f] p-4 rounded-xl border border-[#1e293b] flex items-start gap-3">
                  <div className="p-2 rounded-lg bg-[#1e293b] text-[#c5a059] shrink-0">
                    <Scale size={20} />
                  </div>
                  <div>
                    <h4 className="text-white font-bold text-sm">Confronto Soluzioni plurimandatario</h4>
                    <p className="text-xs text-slate-400 mt-1">Valutiamo più opzioni sul mercato tramite la nostra rete di intermediari e compagnie per proporti garanzie chiare.</p>
                  </div>
                </div>
                ...
                <div className="bg-[#0a192f] p-4 rounded-xl border border-[#1e293b] flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-white font-bold text-sm">Contatto Umano & Presenza sul Territorio</h4>
                    <p className="text-xs text-slate-400 mt-1">Nessun call center impersonale o bot. Risponde direttamente Simone Facchi nel suo studio di Rho (MI).</p>
                  </div>
                </div>

                <div className="bg-gradient-to-r from-[#1e293b] to-[#112240] p-4 rounded-xl border border-[rgba(197,160,89,0.3)] flex items-center justify-between">
                  <div>
                    <span className="text-xs text-slate-400 block">Sede Ufficiale:</span>
